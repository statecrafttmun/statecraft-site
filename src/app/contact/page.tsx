        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            <p className="text-gray-400 text-lg leading-relaxed font-light">
              Whether you are a delegate, faculty advisor, or prospective
              partner, the Secretariat is here to address your queries.
            </p>
              ...
              {[
                {
                  ...
                  val: "contact@statecrafthansraj.info",
                },
                {
                  icon: Phone,
                ...
                {
                  icon: MapPin,
                  title: "Secretariat Office",
                  val: "Hansraj College, University of Delhi, Mahatma Hansraj Marg, Malkaganj, Delhi 110 007",
                },
              ].map((item, i) => (
                <div key={i} className="flex items-start gap-6 group">
                  ...
                  <div className="pt-2">
                    <h3 className="text-white font-bold mb-1 font-serif text-lg">
                      {item.title}
                    </h3>
          ...
          >
            ...
            <h2 className="text-2xl font-bold mb-8 font-serif text-white">
              Send a Message
            </h2>
            <form
              className="space-y-6"
              onSubmit={(e) => {
                ...
                const first = (
                  form.elements.namedItem("first") as HTMLInputElement
                ).value;
                const last = (
                  form.elements.namedItem("last") as HTMLInputElement
                ).value;
                const topic = (
                ...
                window.location.href = `mailto:Contact@statecrafthansraj.info?subject=${encodeURIComponent(
                  subject
            ...
            >
              ...
              <div className="relative">
                <label
                  className={clsx(
                    "text-xs font-bold uppercase tracking-wider mb-2 block transition-colors",
                    focusedField === "topic"
                      ? "text-[var(--color-gold)]"
                      : "text-gray-500"
                  )}
  ...
  return (
    <div className="space-y-2">
      <label
        className={clsx(
          "text-xs font-bold uppercase tracking-wider block transition-colors",
          focused === id ? "text-[var(--color-gold)]" : "text-gray-500"
        )}
      >
        {label}
      </label>
