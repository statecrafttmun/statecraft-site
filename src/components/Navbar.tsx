...
import { Menu, X, Home, Calendar, BookOpen, Users, Mail, Image } from "lucide-react"; // Added Image icon
                ...
                <div className="container mx-auto px-6 flex items-center justify-between">
                    ...
                    <Link href="/" className="group flex items-center gap-3">
                        <div className="relative w-8 h-8 rounded-full border border-[var(--color-gold)] flex items-center justify-center overflow-hidden bg-black/50">
                            ...
                            <img src="/logo-crest.jpg" alt="HRCMUN Logo" className="w-full h-full object-cover" />
                        </div>
                        ...
                        return (
                            <Link
                                ...
                                className={clsx(
                                    ...
                                    isActive ? "text-[var(--color-gold)] -translate-y-1" : "text-gray-500 hover:text-gray-300"
                                )}
                            >
                                <Icon size={20} strokeWidth={isActive ? 2.5 : 1.5} />
                                <span className={clsx("text-[10px] font-medium transition-opacity", isActive ? "opacity-100" : "opacity-0")}>
                                    {link.name}
                                </span>
                            </Link>
                        );
                ...
                {isOpen && (
                    ...
                    >
                        ...
                        <div className="absolute top-6 left-6 flex items-center gap-3 opacity-50">
                            ...
                            <span className="font-serif text-white/50 tracking-widest">MENU</span>
                        </div>
                        ...
                        <div className="flex flex-col gap-8 text-center relative z-10 font-serif">
                            ...
                            >
                                <span className="text-xs text-[var(--color-gold)] tracking-[0.2em] uppercase">Connect</span>
                                <div className="h-[1px] w-12 bg-white/10 mx-auto" />
                                <a href="mailto:contact@statecrafthansraj.info" className="text-sm text-gray-400">
