        ...
        <footer className="relative bg-[#020308] border-t border-white/5 pt-20 pb-10 overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
                    ...
                    <div className="md:col-span-5 space-y-6">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed max-w-sm font-light">
                            Cultivating the next generation of diplomats and leaders through rigorous debate, statesmanship, and the pursuit of honor.
                        </p>
                        <div className="flex gap-4 pt-2">
                            <SocialButton href="https://instagram.com" icon={Instagram} />
                            <SocialButton href="https://linkedin.com" icon={Linkedin} />
                            <SocialButton href="mailto:contact@statecrafthansraj.info" icon={Mail} />
                        </div>
                    </div>
                    ...
                    <div className="md:col-span-3">
                        ...
                        <ul className="space-y-3">
                            {["Home", "Events", "Publications", "About", "Contact"].map((item) => (
                                <li key={item}>
                                    <Link
                    ...
                    <div className="md:col-span-4">
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-4 text-sm text-gray-400">
                                <MapPin className="shrink-0 text-[var(--color-gold)] mt-0.5" size={16} />
                                <span>
                                    Hansraj College, University of Delhi<br />
                                    Mahatma Hansraj Marg, Malkaganj,<br />
                                    Delhi - 110007
                                </span>
                            </li>
                ...
                <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-600">
                    <p>
                        © {new Date().getFullYear()} Hansraj College MUN Society. All rights reserved.
                    </p>
